<template>
  <UView name="采集数据">
    <UViewSearch v-model="searchModel">
      <URow col="search">
        <USelectItem field="productId" label="所属产品" labelField="name" valueField="id" url="/iot/product/listByNonGateway"/>
...
export default {
  ...
  setup() {
    let columns = ref([
      ...
      {field: "field", title: "模型属性", width: 80, resizable: true},
      {field: "fieldName", title: "属性名称", width: 120, resizable: true},
      {field: "address", title: "采集地址", width: 60, resizable: true},
